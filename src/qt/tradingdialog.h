...
private slots:
    ...
    QString BuySkeletonRevive(QString OrderType, double Quantity, double Rate);
    QString SellSkeletonRevive(QString OrderType, double Quantity, double Rate);
