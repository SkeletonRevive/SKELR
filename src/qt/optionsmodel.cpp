...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeSkeletonReviveAmount"))
        settings.setValue("nAnonymizeSkeletonReviveAmount", 1000);
    nAnonymizeSkeletonReviveAmount = settings.value("nAnonymizeSkeletonReviveAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeSkeletonReviveAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeSkeletonReviveAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeSkeletonReviveAmount:
            return QVariant(nAnonymizeSkeletonReviveAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeSkeletonReviveAmount:
            nAnonymizeSkeletonReviveAmount = value.toInt();
            settings.setValue("nAnonymizeSkeletonReviveAmount", nAnonymizeSkeletonReviveAmount);
            emit AnonymizeSkeletonReviveAmountChanged(nAnonymizeSkeletonReviveAmount);
            break;
        default:
            break;
        }
